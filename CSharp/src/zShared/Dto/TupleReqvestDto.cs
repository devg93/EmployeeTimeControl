...
public class TupleReqvestDto
{
    ...
    // public TupleReqvestDto(List<DateTime>? EndTime, List<DateTime>? StartTime, List<DateTime>? OnlineTime, List<DateTime>? OflineTime)
    // {
    //     this.EndTime = EndTime;
    //     this.StartTime = StartTime;
    //     this.OnlineTime = OnlineTime;
    //     this.OflineTime = OflineTime;
    // }
