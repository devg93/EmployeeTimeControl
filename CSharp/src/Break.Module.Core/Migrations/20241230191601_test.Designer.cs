...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Break.Module.Core.Entity.BrakeTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Break.Module.Core.Entity.DateTimeWorkSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Break.Module.Core.Entity.busyChecker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Break.Module.Core.Entity.BrakeTime", b =>
                {
                    b.HasOne("Break.Module.Core.Entity.busyChecker", "busyChecker")
                        .WithMany()
            ...
            modelBuilder.Entity("Break.Module.Core.Entity.DateTimeWorkSchedule", b =>
                {
                    b.HasOne("Break.Module.Core.Entity.BrakeTime", null)
                        .WithMany("EndTime")
